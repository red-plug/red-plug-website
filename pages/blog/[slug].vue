            ...
            <div class="max-w-4xl mx-auto pb-8">
                <div class="md:mt-8 p-8 md:px-4">
                    ...
                    <span class="mb-4 block text-sm">
                        Publicado el {{ publishDate }} <span v-if="post.authorName"> por <a v-text="post.authorName" :href="post.authorUrl" target="_blank" rel="noopener noreferrer" class="text-primary"></a> </span>
                    </span>
